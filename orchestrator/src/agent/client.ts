...
1. Läs raw_text och resonera fram strukturerade fält: kundnamn, typ av
   tjänst, plats, utförda arbetsmoment (beskrivning + mängd + enhet),
   timmar, material som använts, och eventuella anteckningar. Anropa sedan
...
2. Bestäm om detta ska bli en faktura eller en offert:
   - Om arbetsmomenten är standardtjänster med kända priser: anropa
     create_invoice_draft med description+quantity per rad. Anropa ALDRIG
     med ett pris själv — verktyget slår upp priset. Om verktyget svarar
     "no_price_found", anropa istället create_quote_draft för det jobbet.
