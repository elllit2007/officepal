...
// ---------------------------------------------------------------------------
// Insert-typer (utan server-genererade fält) — bekvämlighet för API-routes
// och orchestratorn.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Database-typ i @supabase/supabase-js Generic Database-format
// (createClient<Database>(...)), om/när supabase-js läggs till som beroende.
// ---------------------------------------------------------------------------
